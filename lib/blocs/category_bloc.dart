...
class CategoryBloc extends BlocBase {
  ...
  Future saveData() async {
    ...
    if (image != null) {
      ...
      datatoUpload["icon"] = await snap.ref.getDownloadURL();
    }

    if (category == null || title != category.data["title"]) {
      datatoUpload["title"] = title;
    }
    ...
    if (category == null) {
      ...
      category.reference.updateData(datatoUpload);
    }

    _saveController.add(false);
  }
